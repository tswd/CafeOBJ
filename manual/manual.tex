...
In this case, \kbd{TRUTH} and \kbd{BOOL} are loaded in automatic.
...
with suffixes ``kbd{.cafe}''\footnote{The older systems prior
  to version 1.4.8 used a diffrenct suffix ``\kbd{.mod}''. 
...
above default paths (in case of \kbd{+} or \kbd{+l} options).
...
first unsuccessfully and second successfully.
